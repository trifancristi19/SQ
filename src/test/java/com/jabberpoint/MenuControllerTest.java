...
public class MenuControllerTest {
    ...
    public void setUp() {
        ...
        if (isHeadless) {
            ...
            frame = new Object(); // Simple mock
            menuController = new MockMenuController(presentation);
        } else {
            frame = new Frame();
            menuController = new MenuController((Frame)frame, presentation);
        }
    }
    ...
    public void testMenuCreation() {
        ...
        if (isHeadless) {
            MockMenuController mockController = (MockMenuController)menuController;
            assertTrue("MockMenuController should have at least one menu", 
                      mockController.getMenuCount() > 0);
        } else {
            MenuController realController = (MenuController)menuController;
    ...
    private static class MockMenuController {
        ...
        private static class MockMenu {
            ...
            public boolean hasItem(String itemLabel) {
                return items.contains(itemLabel);
            }
